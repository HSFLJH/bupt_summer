...
def main():
    ...
    parser.add_argument("--model-path", type=str, help="训练好的模型权重路径",
                        default="/home/lishengjie/study/sum_hansf/bupt_summer/mask-r-cnn/torchvision/result/three/model_final.pth")
    ...
    parser.add_argument("--save-dir", type=str, help="可视化结果保存目录",
                        default="/home/lishengjie/study/sum_hansf/bupt_summer/mask-r-cnn/torchvision/result/result_pngs/one")
